    ...
    <div className="space-y-6">
      ...
      <div className="mt-8 p-6 bg-accent border border-border/50 rounded-2xl shadow-inner relative overflow-hidden group">
        ...
        <div className="relative z-10 flex justify-between items-center">
          <div className="flex flex-col">
            <span className="text-xs font-bold text-accent-foreground/60 uppercase tracking-tighter">
              Grand Total Claim
            </span>
            <span className="text-sm font-medium text-accent-foreground/40 italic">
              Calculated amount in SBD
            </span>
          </div>
